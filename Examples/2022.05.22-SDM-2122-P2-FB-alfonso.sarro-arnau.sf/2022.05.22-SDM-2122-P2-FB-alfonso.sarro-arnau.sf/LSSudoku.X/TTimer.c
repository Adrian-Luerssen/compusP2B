...
void TiInitTimer(void) {
    ...
    //@ 40MHz (Tinst = 100nS), we want 0.833ms/Tinst=10.000 tics 2^16-10.000=0xD8F0 ( cuz BAUDRATE 1200)
    TMR0H = 0xDF;
    TMR0L = 0x73;
...
//Timer Interrupt Service Routine
    //@ 40MHz (Tinst = 100nS), we want 0.8333ms/Tinst=10.000 tics 2^16-10.000=0xD8F0 (0.833 cuz BAUDRATE 1200)
    TMR0H = 0xDF;
    TMR0L = 0x73;
