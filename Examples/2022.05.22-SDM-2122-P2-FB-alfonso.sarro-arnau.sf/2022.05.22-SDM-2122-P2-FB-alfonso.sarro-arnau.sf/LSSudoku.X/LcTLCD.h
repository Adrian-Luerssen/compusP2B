...
//
// VCli V1.4, arnau.nau, @ 2022. Added LcDelete function. Modified PutChar to take into
// account initialization parameters (specifically Columns) when jumping line or not.
...
#define SetD4(On)				(LATDbits.LATD3 = (On))
#define SetD5(On)				(LATDbits.LATD2 = (On))
#define SetD6(On)				(LATDbits.LATD0 = (On))
#define SetD7(On)				(LATDbits.LATD1 = (On))
#define GetBusyFlag()                           (PORTDbits.RD1)
#define RSUp()					(LATDbits.LATD6 = 1)
#define RSDown()				(LATDbits.LATD6 = 0)
#define RWUp()					(LATDbits.LATD5 = 1)
#define RWDown()				(LATDbits.LATD5 = 0)
#define EnableUp()				(LATDbits.LATD4 = 1)
#define EnableDown()                            (LATDbits.LATD4 = 0)
// -------------------------------END--HARDWARE---AREA--------------------

#define PRINT_MARQUEE 3
#define PRINT_SHIFTING 2
#define PRINT_COMPLETED 1
#define PRINT_BUSY 0
...
//Example of use:
/*
if (LcPrintLine(charString) == PRINT_COMPLETED) {
    //step after print has finished.
}
*/

char LcPrintSecondLine (char * c);
//PRE: string is not longer than 255 characters. (length and shift would overflow)
//POST: prints the string on the second row of the LCD cooperatively. Meant to be used as a marquee simultaneously with LcPrintLine().
//(needs to be called repetitively from motor and control return value)
//Example of use:
/*
if (LcPrintLine(charString) == PRINT_COMPLETED) {
