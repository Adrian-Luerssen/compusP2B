...
void motorLogic(void) {
    switch(state) {
        ...
        case 0:
            ...
            break;
        case 1:
            if(LcPrintLine("2.REGISTER") == 1) {state++; writing = 0;}
            break;
        case 2:
            if (key == '2' || key == '1') {
                state++;
...
# 170 "Logic.c"
        ...
        case 3:
            ...
            break;
        case 4:
            if(LcPrintLine("PSWD:\n") == 1) {state++; LcGotoXY(6, 0); KeEnableSMS(); position = 0;}
            break;
        case 5:
            if(position >= 8) {
                key = '#';
        ...
        case 6:
            ...
            break;
        case 7:
            if(LcPrintLine("2.MODIFY TIME\n") == 1) {if(menuPos == 7) {state++;} else {state = 11;}}
            break;
        case 8:
        ...
        case 46:
            ...
            break;
        case 29:
            if(LcPrintLine("BYE BYE ") == 1) {
                state++;
            }
            break;
        case 30:
            if(LcPrintLine(user) == 1) {
                TiResetTics(tLogic);
                state++;
            }
            break;
