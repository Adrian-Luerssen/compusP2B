...
char LcPrintSecondLine (char * c2) {
  ...
  shift2 = 0;
    ...
    WaitForBusy();
    LcGotoXY(pointer2, 1);
  if (flag2 == 2 || length2 == 0) {
   if (GetSecondLength(c2) == 0)
    pointer2 = 0;
  }
  else {
                if (length2 > Columns && pointer2 >= 16) {
                    ...
                    aux2 = *(c2+((pointer2+shift2)%length2));
...
void CantaPartAlta(char c) {
  (LATDbits.LATD1 = (c & 0x80 ? 1 : 0));
  (LATDbits.LATD0 = (c & 0x40 ? 1 : 0));
  (LATDbits.LATD2 = (c & 0x20 ? 1 : 0));
  (LATDbits.LATD3 = (c & 0x10 ? 1 : 0));
}

void CantaPartBaixa(char c) {
  (LATDbits.LATD1 = (c & 0x08 ? 1 : 0));
  (LATDbits.LATD0 = (c & 0x04 ? 1 : 0));
  (LATDbits.LATD2 = (c & 0x02 ? 1 : 0));
  (LATDbits.LATD3 = (c & 0x01 ? 1 : 0));
}
...
void WaitForBusy(void) { char Busy;
 ...
 TiResetTics(Timer);
 do {
  (LATDbits.LATD4 = 1);(LATDbits.LATD4 = 1);
  Busy = (PORTDbits.RD1);
  (LATDbits.LATD4 = 0);
  (LATDbits.LATD4 = 0);
  (LATDbits.LATD4 = 1);(LATDbits.LATD4 = 1);
...
void EscriuPrimeraOrdre(char ordre) {
 ...
 (TRISDbits.TRISD0 = TRISDbits.TRISD1 = TRISDbits.TRISD2 = TRISDbits.TRISD3 = 0); (LATDbits.LATD6 = 0); (LATDbits.LATD5 = 0);
 (LATDbits.LATD4 = 1); (LATDbits.LATD4 = 1);
  (LATDbits.LATD1 = (ordre & 0x08 ? 1 : 0));
  (LATDbits.LATD0 = (ordre & 0x04 ? 1 : 0));
  (LATDbits.LATD2 = (ordre & 0x02 ? 1 : 0));
  (LATDbits.LATD3 = (ordre & 0x01 ? 1 : 0));
 (LATDbits.LATD4 = 0);
}
