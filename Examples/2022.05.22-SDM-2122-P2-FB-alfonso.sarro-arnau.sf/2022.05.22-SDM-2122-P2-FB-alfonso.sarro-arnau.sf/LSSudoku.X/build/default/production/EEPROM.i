...
void motorROM() {
    switch(state) {
        ...
        case 4:
            ...
            break;
        case 5:
            if(compare(userInputROM, userR) != 0) {
                if(flagReading == 1) {
                    flagReading = 0;
                    pointer = 0;
            ...
            break;
        case 6:
            if(compare(passInputROM, passR) != 0) {
                if(flagReading == 1) {
