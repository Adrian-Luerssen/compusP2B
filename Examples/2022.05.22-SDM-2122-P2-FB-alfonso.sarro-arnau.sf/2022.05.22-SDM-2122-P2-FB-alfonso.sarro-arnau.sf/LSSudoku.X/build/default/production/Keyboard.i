...
void KeDisableSMS(void);

void KeEnableSMS(void);
# 1 "Keyboard.c" 2
...
void initKeyboard(void) {
 ...
 tSMS = TiGetTimer();
    TRISE = 0x08;
    TRISBbits.TRISB2 = TRISBbits.TRISB3 = TRISBbits.TRISB4 = TRISBbits.TRISB5 = 1;
    numerical = 1;
}
...
void motorKeyboard(void) {
 ...
 switch(state) {
  case 0:
   if ((PORTBbits.RB5 == 1 || PORTBbits.RB4 == 1 || PORTBbits.RB3 == 1 || PORTBbits.RB2 == 1)) {
                if (PORTBbits.RB5 == 1) row = 0;
                else if (PORTBbits.RB4 == 1) row = 1;
                else if (PORTBbits.RB3 == 1) row = 2;
                else { row = 3; }
   ...
   break;
  case 1:
   if (TiGetTics(tDebounce) >= 10 && !(PORTBbits.RB5 == 1 || PORTBbits.RB4 == 1 || PORTBbits.RB3 == 1 || PORTBbits.RB2 == 1)) {
    state--;
   }
   else if (TiGetTics(tDebounce) >= 10 && (PORTBbits.RB5 == 1 || PORTBbits.RB4 == 1 || PORTBbits.RB3 == 1 || PORTBbits.RB2 == 1)) {
    TiResetTics(tSMS);
    state++;
   }
   break;
               ...
               state = 0;
                ...
                if ((PORTBbits.RB5 == 1 || PORTBbits.RB4 == 1 || PORTBbits.RB3 == 1 || PORTBbits.RB2 == 1)) {
                    ...
                    if (!(prev_row == row && prev_column == column)) {
                        ...
                        if((table[row][column][sms+1] == '\0') || table[row][column][0] == '*' || table[row][column][0] == '#') {
                            sms = 0;
                        } else {
                            sms++;
                        }
