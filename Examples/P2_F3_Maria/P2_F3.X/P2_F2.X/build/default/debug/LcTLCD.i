...
void LcInit(char rows, char columns) {
 ...
 RowAct = ColumnAct = 0;
 (TRISCbits.TRISC2 = TRISCbits.TRISC1 = TRISCbits.TRISC0 = 0);
 for (i = 0; i < 2; i++) {
  Espera(Timer, 100);
...
void LcPutScore(char score){
    LcPutChar(' ');
    if(score > 99){
        LcPutChar((score/100)+'0');
        LcPutChar((score%100)/10+'0');
        LcPutChar((score%10)+'0');
    }else if (score > 9){
        LcPutChar((score/10)+'0');
        LcPutChar((score%10)+'0');
    }else{
...
void CantaIR(char IR) {
 (TRISBbits.TRISB0 = TRISDbits.TRISD2 = TRISDbits.TRISD1 = TRISDbits.TRISD0 = 0);
 (LATCbits.LATC0 = 0);
 (LATCbits.LATC1 = 0);
 (LATCbits.LATC2 = 1);
 CantaPartAlta(IR);
 ...
 (LATCbits.LATC2 = 1);
 (LATCbits.LATC2 = 0);
 (TRISBbits.TRISB0 = TRISDbits.TRISD2 = TRISDbits.TRISD1 = TRISDbits.TRISD0 = 1);
}
...
void WaitForBusy(void) { char Busy;
 ...
 TiResetTics(Timer);
 do {
  (LATCbits.LATC2 = 1);(LATCbits.LATC2 = 1);
  Busy = (PORTBbits.RB0);
  (LATCbits.LATC2 = 0);
  (LATCbits.LATC2 = 0);
  (LATCbits.LATC2 = 1);(LATCbits.LATC2 = 1);
...
void EscriuPrimeraOrdre(char ordre) {
 ...
 (TRISBbits.TRISB0 = TRISDbits.TRISD2 = TRISDbits.TRISD1 = TRISDbits.TRISD0 = 0); (LATCbits.LATC0 = 0); (LATCbits.LATC1 = 0);
 (LATCbits.LATC2 = 1); (LATCbits.LATC2 = 1);
  (LATBbits.LATB0 = (ordre & 0x08 ? 1 : 0));
