...
void initKeypad(){
    (TRISDbits.TRISD7 = TRISDbits.TRISD6 = TRISDbits.TRISD5 = TRISDbits.TRISD4 = 0);
    (TRISBbits.TRISB1 = TRISBbits.TRISB2 = TRISBbits.TRISB3 = 1);
    (LATDbits.LATD7 = LATDbits.LATD6 = LATDbits.LATD5 = LATDbits.LATD4 = 1);
    keypadState = 0;
...
void motorKey(){
    switch(keypadState){
        case 0:
            ...
            if(TiGetTics(timerKeypad)>1200) KeyResetValue();
        ...
        case 1:
            if(TiGetTics(timerKeypad) > 24)
                if(!((PORTBbits.RB1) && (PORTBbits.RB2) && (PORTBbits.RB3))==1){
                    if(PORTBbits.RB2 == 0) cols=0;
                    else if(PORTBbits.RB1 == 0) cols=1;
                    else if(PORTBbits.RB3 == 0) cols=2;
                    ++keypadState;
                }
                else --keypadState;
            break;
        case 2:
            ...
            break;
        case 3:
            if (!((PORTBbits.RB1) && (PORTBbits.RB2) && (PORTBbits.RB3))==0){
                TiResetTics(timerKeypad);
                keypadState=0;
            }
            break;
